...
| Notebook | Colab |
| --- | --- |
| [from_value_iteration_to_ppo](teaching/reinforcement_learning/from_value_iteration_to_ppo.ipynb) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/alx87grd/minilink/blob/main/examples/teaching/reinforcement_learning/from_value_iteration_to_ppo.ipynb) |
...
| [cost_to_go_function_approximation](teaching/reinforcement_learning/cost_to_go_function_approximation.ipynb) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/alx87grd/minilink/blob/main/examples/teaching/reinforcement_learning/cost_to_go_function_approximation.ipynb) |
...
| Reinforcement learning | [11_reinforcement_learning](tutorial/11_reinforcement_learning.ipynb), [showcase_from_rl_to_bode](tutorial/showcase_from_rl_to_bode.ipynb) | [`demos/rl/`](demos/rl/) (Q-learning vs value iteration, SARSA vs Q-learning, REINFORCE vs actor-critic vs PPO, PPO vs SAC, swing-ups, car, rocket, drone) | [from value iteration to PPO](teaching/reinforcement_learning/from_value_iteration_to_ppo.ipynb), [policy gradient to PPO](teaching/reinforcement_learning/policy_gradient_to_ppo.ipynb), [Gymnasium interface](teaching/reinforcement_learning/gymnasium_interface.ipynb), [VI vs LQR vs RL](teaching/reinforcement_learning/pendulum_swing_up_vi_vs_lqr_vs_rl.ipynb), [learn to fly](teaching/reinforcement_learning/drone_learn_to_fly.ipynb), [function approximation by SGD](teaching/reinforcement_learning/function_approximation_sgd.ipynb), [cost-to-go approximation](teaching/reinforcement_learning/cost_to_go_function_approximation.ipynb); research prototypes in [`experimental/rl/`](experimental/rl/) |
