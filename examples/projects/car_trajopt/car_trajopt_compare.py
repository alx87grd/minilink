...
Run from repo root::
    ...
    python examples/projects/car_trajopt/car_trajopt_compare.py
...
# SE bend from the wide technical circuit (mpc_circuit), with lead-in/out.
CORNER_XY = np.array(
    [
        [5.0, -10.0],
        [10.5, -10.0],
...
_plot_overlay_and_speed(
    corner_runs,
    title="Corner",
    draw_background=lambda ax: track.plot(show=False, ax=ax, bounds=bounds, title=""),
)
