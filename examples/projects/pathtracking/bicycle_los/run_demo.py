...
Run from repo root:
    ...
    PYTHONPATH=. python examples/projects/pathtracking/bicycle_los/run_demo.py
"""
...
from examples.projects.pathtracking.bicycle_los.los import LOS
from examples.projects.pathtracking.bicycle_los.motor_map import (
