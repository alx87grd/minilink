...
| docs/ | Sphinx autodoc (`docs/api/`, `docs/index.rst`); the user guide is `examples/tutorial/`. README GIFs and diagram PNG from `docs/make_assets.py` (`ur5_meshcat.gif` is a screen recording, not rebuilt) |
