...
| [phase-E0.md](phase-E0.md) … [phase-E8.md](phase-E8.md) | Per-phase execution cards (E0 full; others stubs until active) |

**Active phase:** expand that `phase-E*.md` before coding; cite it in the PR.
