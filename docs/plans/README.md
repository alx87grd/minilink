...
Architecture and port plans. Contracts in code: [DESIGN.md](../../DESIGN.md), [ROADMAP.md](../../ROADMAP.md).

| Doc | Scope | Status (July 2026) |
| --- | --- | --- |
...
| [planning-ui-simplification.md](planning-ui-simplification.md) | Flat planner-family ctor / Simulator-style defaults (TOP, RRT, DP) | Draft (locked v1 shape) |
| [mpc-rh-refactor/phase-F-cleanup.md](mpc-rh-refactor/phase-F-cleanup.md) | Post-refactor hygiene guidelines (stub until E8) | Stub |
