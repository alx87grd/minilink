...
| File | Role |
| --- | --- |
| [hybrid-discrete-simulation.md](hybrid-discrete-simulation.md) | **Hybrid / step** — `StepSystem` (`phi`), step diagrams, orchestration, multi-rate expansion, narrow hybrid sim |
