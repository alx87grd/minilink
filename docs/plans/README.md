...
| [derivatives-facade.md](derivatives-facade.md) | `sys.jacobian("f", "x")`, `sys.linearize(...)` and one calling pattern for the analysis family (`bode`, `pzmap`, `transfer_function`, …) | Teaching surface — draft v4, awaiting rulings |
