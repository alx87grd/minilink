...
| File | Role |
| --- | --- |
| [hybrid-discrete-simulation.md](hybrid-discrete-simulation.md) | **Hybrid / step** — `StepSystem` (`phi`), ZOH sampled controller → plant (MPC, SMC), multi-rate expansion on `dt_base` |
