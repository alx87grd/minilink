...
| [derivatives-facade.md](derivatives-facade.md) | `sys.jacobian("f", "x")` and `sys.linearize(...)` on every `System` (JAX exact, finite-difference backup) | Teaching surface — draft v3, awaiting rulings |
