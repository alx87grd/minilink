...
| --- | ---: | ---: | ---: | ---: | ---: |
| Library symbols (table below) | 104 | 77 | 10 | 13 | 4 |
| Example scripts | 195 | 17 | 45 | 94 | 39 |
| Minilink scripts | 52 | — | — | — | — |
...
| `demos_by_system/robot_arm_5dof/fivelinkrobot_kinematic_nullspace_controller.py` | **TODO** | control/robotic.py + manipulator rebase |
