...
[`manipulator_eom.ipynb`](../../examples/teaching/topics/robotics/manipulator_eom.ipynb)
...
One robot, three engines — [`manipulator_eom.ipynb`](../../examples/teaching/topics/robotics/manipulator_eom.ipynb):
