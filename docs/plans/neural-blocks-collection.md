...
**Demo** — `examples/demos/compile/neural_controller_jax.py`: wires
...
| Matches TODO.md Later placement (`interfaces/` for ecosystem bridges) | Flax adapter must map pytree → nested `params` dict |
