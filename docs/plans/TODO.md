...
- [ ] **Core math objects** — `core-objects-1-governance.md` … `core-objects-6-demos.md` (reviewed 2026-09-15; every step name-preserving for the GRO860 notebooks, schedule at the maintainer's call):
