...
- [x] **v0.1 docs freeze (2026-09-16)** — Sphinx autodoc of the teaching-lane API only (`docs/api/experimental.rst` dropped); user guide is `examples/tutorial/`; README API badge; install.md states conda is the supported path and pip files are prepared, not supported. C export TRL 1.
