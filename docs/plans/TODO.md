...
- [ ] **S39 Demo-script headers → one-line title** **[ask — examples]** (style approved 2026-09-05). 63 scripts, 434 header lines. **Needs a joint session:** a dry run showed the headers mix run instructions (drop) with lesson prose (e.g. why the pendulum RRT must pump energy) that should move next to the code, not vanish — editorial, not mechanical. Notebooks untouched.
