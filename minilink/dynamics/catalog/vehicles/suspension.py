...
from minilink.core.kinematics import identity_matrix, rod_between_transform, translation_matrix
from minilink.core.system import DynamicSystem
from minilink.graphical.animation.legacy import legacy_arrow_vector
from minilink.graphical.animation.primitives import Box, CustomLine, empty_transform, spring_line
...
class QuarterCarOnRoughTerrain(DynamicSystem):
    ...
    def tf(self, x, u, t=0, params=None):
        return {
            ...
            "mass": translation_matrix(x[2], x[1], 0.0),
        }
    ...
    def get_dynamic_geometry(self, x, u, t=0, params=None):
        ...
        if self.params["k"] != 0.0:
            spring.local_transform = rod_between_transform(
                [x[2], ground, 0.0],
                [x[2], mass_y - 0.2, 0.0],
            )
        else:
            spring.local_transform = empty_transform()
        return {
            "world": [
                spring,
                legacy_arrow_vector(
