...
class DoublePendulum(MechanicalSystem):
    ...
    def tf(self, x, u, t=0, params=None):
        ...
        return {
            ...
            "link0": pose2d_matrix(p0[0], p0[1], theta1),
            "link1": pose2d_matrix(p1[0], p1[1], theta12),
            "joint0": pose2d_matrix(p0[0], p0[1], rod1_angle),
            "joint1": pose2d_matrix(p1[0], p1[1], rod2_angle),
        }
    ...
    def get_dynamic_geometry(self, x, u, t=0, params=None):
        ...
        torque_radius = 0.2 * max(self.params["l1"], self.l2)
        return {
            "world": [
                legacy_torque_world(
                    p0[0], p0[1], rod1_angle, -u[0] * torque_scale, torque_radius
                ),
                legacy_torque_world(
                    p1[0], p1[1], rod2_angle, -u[1] * torque_scale, torque_radius
                ),
            ],
        }
...
class Acrobot(DoublePendulum):
    ...
    def get_dynamic_geometry(self, x, u, t=0, params=None):
        ...
        return {
            "world": [
                legacy_torque_world(
                    p1[0], p1[1], rod2_angle, -u[0] * torque_scale, torque_radius
                )
            ],
        }
    ...
    def tf(self, x, u, t=0, params=None):
        ...
        return {key: frames[key] for key in ("world", "link0", "link1", "joint1")}

    def get_kinematic_geometry(self):
        geometry = super().get_kinematic_geometry()
        return {key: geometry[key] for key in ("world", "link0", "link1")}
