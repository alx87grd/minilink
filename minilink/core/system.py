...
class System(SystemFacades):
    ...
    - **Visualization contract**: it may describe forward-kinematic geometry
      ...
      review). Default ``camera_*`` fields configure the animation camera
      via :mod:`minilink.graphical.animation.camera`.
    ...
    def __init__(self, n=0):
        ...
        # Camera hints resolved at animation time (see graphical.animation.camera).
    ...
    def get_kinematic_geometry(self):
        ...
        Default is empty; opt in via :func:`~minilink.graphical.animation.visualization.debug_state_skin`
