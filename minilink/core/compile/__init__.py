...
Import from defining modules, for example::
    ...
    from minilink.core.compile.evaluators.numpy_evaluator import NumpyDiagramEvaluator, NumpyDynamicEvaluator

Optional JAX evaluators (requires ``pip install minilink[jax]``)::

    from minilink.core.compile.evaluators.jax_evaluator import JaxDiagramEvaluator, JaxDynamicEvaluator
