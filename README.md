...
| Trajectory optimization | `examples/scripts/trajectory_optimization/` · [car models + TrajOpt compare](examples/notebooks/demo_car_trajopt_compare.ipynb) · [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/alx87grd/minilink/blob/main/examples/notebooks/demo_car_trajopt_compare.ipynb) |
