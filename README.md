...
| Trajectory optimization | `examples/scripts/trajectory_optimization/` · [obstacle-scene model compare](examples/notebooks/demo_bicycle_trajopt_obstacle_scene_compare.ipynb) |
